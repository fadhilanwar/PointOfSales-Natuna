...
<body class="bg-[#F4F7F9] min-h-screen flex items-center justify-center p-4 font-['Plus_Jakarta_Sans'] text-gray-800">
    ...
    <div
        ...
        @if(session('success'))
            <div class="bg-emerald-50 border-l-4 border-emerald-500 text-emerald-700 p-4 rounded-r-lg text-sm font-medium mb-5" role="alert">
                {{ session('success') }}
            </div>
        @endif
        ...
        <div class="text-center">
            <p class="text-sm text-gray-600 font-medium mb-3">Belum punya akun?</p>
            <a href="{{ route('register') }}"
                class="inline-flex items-center justify-center gap-2 w-full bg-white border-2 border-[#06728A] text-[#06728A] font-bold rounded-xl py-3 hover:bg-[#06728A] hover:text-white transition-all duration-300 active:scale-[0.98]">
