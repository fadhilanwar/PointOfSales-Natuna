...
<body
    ...
    <header
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 py-4 flex justify-between items-center gap-8">
            ...
            <div class="flex-1 max-w-2xl relative group cursor-pointer">
                ...
                <input type="text"
                    class="w-full bg-gray-100 hover:bg-gray-200/50 focus:bg-white border border-transparent focus:border-[#06728A] rounded-full py-2.5 pl-12 pr-4 text-sm font-medium focus:outline-none focus:ring-4 focus:ring-[#06728A]/10 shadow-sm hover:shadow transition-all duration-300 ease-in-out cursor-pointer"
    ...
    <main class="max-w-7xl mx-auto md:px-6 lg:px-8 selection:bg-[#06728A] selection:text-white">
        @yield('content')
    </main>
