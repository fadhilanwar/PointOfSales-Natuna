            ...
            <table class="w-full text-sm text-left text-slate-500">
                <thead class="text-xs text-slate-500 uppercase bg-slate-50 border-b border-slate-100">
                    <tr>
                        ...
                        <th scope="col" class="py-4 px-6 font-semibold">Harga Modal</th>
                        <th scope="col" class="py-4 px-6 font-semibold">Harga Jual</th>
                ...
                <tbody class="divide-y divide-slate-100">
                    @forelse($products as $product)
                        <tr class="hover:bg-slate-50 transition-colors duration-200 group">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    @if ($product->image_path)
                                        <img src="{{ asset('storage/' . $product->image_path) }}" alt="{{ $product->name }}"
                                            class="h-10 w-10 shrink-0 rounded-lg object-cover border border-slate-200 shadow-sm bg-white">
                                    @else
                                        <div
                                    ...
                                    <div>
                                        ...
                                        <span class="text-xs text-slate-400 block mt-0.5">Barcode:
                            ...
                            <td class="py-4 px-6">
                                <span class="font-medium text-slate-600">Rp
                            ...
                            <td class="py-4 px-6">
                                ...
                                @elseif($product->stock > 0)
                                    <div
                                        class="inline-flex items-center gap-1.5 rounded-full bg-amber-50 px-2.5 py-1 text-xs font-medium text-amber-700 ring-1 ring-inset ring-amber-600/20">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="py-10 text-center font-medium text-slate-500">
