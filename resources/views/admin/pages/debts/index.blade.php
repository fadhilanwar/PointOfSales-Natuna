            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50 transition-colors">
                    ...
                    <td class="py-4 px-6 text-right">
                        {{-- Menampilkan Total Hutang yang dihitung di Controller --}}
                    ...
                    <td class="py-4 px-6 text-center">
                        <div class="flex items-center justify-center gap-2">
                            {{-- Tombol Lihat Detail Hutang --}}
                            <a href="{{ route('admin.debts.show', $user->id) }}" class="p-2 text-slate-400 hover:text-[#0a7b8c] bg-slate-50 hover:bg-cyan-50 rounded-lg transition" title="Lihat Detail Transaksi">
                ...
                @empty
                <tr><td colspan="4" class="py-8 text-center text-slate-500">Hebat! Saat ini tidak ada pelanggan yang menunggak hutang.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
